...
const labelClasses = 'block text-sm font-medium text-gray-900 dark:text-gray-300 mt-3 mb-2'
...
const PlayGround = () => {
  ...
  return (
    <div className='flex justify-center items-center  dark:bg-gradient-to-br from-[#333867] to-[#17193b]'>
      <div className='bg-neutral-100 dark:bg-black/30 max-w-md rounded-2xl p-6 shadow-xl'>
        <form
          className='flex flex-wrap w-full'
          onSubmit={(e: FormEvent<HTMLFormElement>) => {
            e.preventDefault()
            const { type, message, duration, position, icon } = e.currentTarget.elements as any
            //
            add({
              type: type.value,
        ...
        >
          ...
          <div className='w-full lg:w-1/2 px-1'>
            ...
            <input name={'duration'} type={'number'} defaultValue={3000} className={inputClasses} />
          </div>
          ...
          <div className='w-full lg:w-1/2 px-1'>
            ...
            <select name={'position'} defaultValue={'topRight'} className={selectClasses}>
                ...
                message: (
                  <div className='text-center'>
                    ...
                    <div className='font-normal p-1'>
                      Take a look{' '}
                      <a className='text-blue-800 dark:text-blue-400' href={'/'}>
                        (Link)
                      </a>
                    </div>
                  </div>
