...
const defaultIconClass = 'shadow-none text-black bg-transparent !absolute right-0 top-0 rounded'
function PasswordInput({
  ...
  return (
    <Input
      ...
      icon={
        isPasswordVisible ? (
          <EyeIcon className='h-5 w-5 cursor-pointer' onClick={togglePasswordVisibility} />
        ) : (
          <EyeSlashIcon className='h-5 w-5 cursor-pointer' onClick={togglePasswordVisibility} />
        )
      }
    />
  )
